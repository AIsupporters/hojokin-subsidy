...
(function (root) {
  ...
  var LAW = {
    ...
    accom_amuse: { small: 20, mid: 100 },    // 宿泊業・娯楽業（小規模は20人特例／中小はサービス業と同じ100人）
  };
  ...
  var INDUSTRY_LAW = {
    ...
    "宿泊・観光業": { type: "accom_amuse", caveat: "宿泊業・娯楽業は小規模事業者の従業員上限が20人（持続化補助金等の小規模区分の特例）。ただし旅行業等は5人ラインの場合あり、実態で要確認。" },
    ...
    "娯楽・イベント業": { type: "accom_amuse", caveat: "娯楽業は小規模事業者の従業員上限が20人（持続化補助金等の小規模区分の特例）。イベント制作等は業態で異なる場合あり、要確認。" },
  ...
  function assessShoukibo(law, size) {
    ...
    if (small >= 20) return { status: "該当", text: "製造業・建設業・運輸業・宿泊業・娯楽業など（従業員20人以下）は小規模事業者に該当します。" };
